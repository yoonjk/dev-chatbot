...
let getConversationResponse = (message, context) => {
  ...
  count = count + 1;
  payload.context.count = count + 1;

  payload = preProcess(context, payload);
...
*/
let preProcess = (context, payload) => {
  var inputText = payload.input.text;
  console.log("--------------------------------------------------");
  console.log("Preprocess User Input : ",inputText);
  console.log("Preprocess User payload : ", payload);
  console.log("--------------------------------------------------");
...
let postProcess = response => {
  console.log("=================================================");
  console.log("prost wcs Output : " + response.output.text);
  console.log("prost wcs utterance Output : " ,response.context);
